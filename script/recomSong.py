...
from getPlaylist import getPlaylistDf
import warnings
...
#so in drop duplicates we need to prevent this situation
...
cid = creds["cid"]
secret = creds["secret"]
token = 'BQD9jyDIOWTwPl9dxRqBIL0epz6J4D8aW8AEOOHpBt-RH_G5LKJiwuL_cW9VM0J_tbiGFnNo26Lv5JGbq2vrZjmkKYPiNnBkspXtJlnK_17N6_86NDUAdj6kWouwio9gQsm0ReGpzVtIcRhwSLYvKO9kNbfS-SeLa5qHkypjXWo'

auth_manager = SpotifyClientCredentials(client_id=cid, client_secret=secret)
sp = spotipy.Spotify(auth_manager=auth_manager)
#token = util.prompt_for_user_token(scope='user-library-read', client_id= cid, client_secret=secret, redirect_uri='http://localhost:8883/')
...
#%%
playlistShower = create_necessary_outputs('Shower Power', id_name,rawData)
...
complete_feature_set_playlist_vector_Shower, complete_feature_set_nonplaylist_Shower = generate_playlist_feature(complete_feature_set, playlistShower, 1.09)
